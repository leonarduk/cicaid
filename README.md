...
```bash
pip install "cicaid-devtools @ https://github.com/leonarduk/cicaid/releases/download/v0.2.0/cicaid_devtools-0.2.0-py3-none-any.whl"
```
<!-- cicaid-version:end -->
...
```bash
pip install "cicaid-devtools[dotenv] @ https://github.com/leonarduk/cicaid/releases/download/v0.2.0/cicaid_devtools-0.2.0-py3-none-any.whl"
```
...
2. Create a new tag (the most recently published release is
   <!-- cicaid-latest-tag:start -->`v0.2.0`<!-- cicaid-latest-tag:end -->,
