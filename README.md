...
```bash
pip install "cicaid-devtools @ https://github.com/leonarduk/cicaid/releases/download/v0.5.2/cicaid_devtools-0.5.2-py3-none-any.whl"
```
<!-- cicaid-version:end -->
...
```bash
pip install "cicaid-devtools[dotenv] @ https://github.com/leonarduk/cicaid/releases/download/v0.5.2/cicaid_devtools-0.5.2-py3-none-any.whl"
```
...
2. Create a new tag (the most recently published release is
   <!-- cicaid-latest-tag:start -->`v0.5.2`<!-- cicaid-latest-tag:end -->,
